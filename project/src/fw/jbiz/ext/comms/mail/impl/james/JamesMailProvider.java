package fw.jbiz.ext.comms.mail.impl.james;
...
public class JamesMailProvider extends ZObject implements IMailProvider {

	static Logger logger = Logger.getLogger(JamesMailProvider.class);
...
//			sun.misc.BASE64Encoder enc = new sun.misc.BASE64Encoder();
	...
	public String getProviderInfo() {
		...
		ZSimpleJsonObject res = new ZSimpleJsonObject();
